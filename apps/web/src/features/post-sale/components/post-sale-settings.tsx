...
import { usePostSaleSettings, useUpdatePostSaleSettings } from "@/features/post-sale/hooks";
        ...
        <CardContent className="flex flex-col gap-4">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              {/* Mesmo seletor que leads e tarefas usam -- vem do diretório da
                  equipe (`/team/directory`), então a lista é a mesma em todo
                  lugar e não há um segundo endpoint de membros pra manter. */}
              <MemberSelect
                value={form.defaultOwnerId === NONE ? null : form.defaultOwnerId}
                onChange={(userId) => set("defaultOwnerId", userId ?? NONE)}
